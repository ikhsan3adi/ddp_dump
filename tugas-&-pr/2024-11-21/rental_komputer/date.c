/* File : date.c */
/* Deskripsi : Unit untuk keperluan Date */
...
tapi implementasinya seringkali hanya menggunakan 4
sebagai pembagi */
{
...
date TanggalSekarang()
{
  ...
  tanggal.Tgl = infoWaktu->tm_mday;        // Hari dalam bulan (1-31)
  tanggal.Bln = infoWaktu->tm_mon + 1;     // Bulan (0-11, ditambah 1 untuk format 1-12)
  tanggal.Thn = infoWaktu->tm_year + 1900; // Tahun sejak 1900
